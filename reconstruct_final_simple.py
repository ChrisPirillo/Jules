...
# Define the full script content (escaped for python string)
# I need to be careful with backslashes in the python string literal.
# Using raw string r"""...""" helps, but `\` at end of line is tricky.
...
start_tag = '<script>'
end_tag = '</script>'
start_idx = content.rfind(start_tag) # Use rfind to get the last script (main one)
...
if start_idx != -1 and end_idx != -1:
    ...
    print("Could not find script tag to replace.")
